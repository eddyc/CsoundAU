...
{
    string theBundleID = bundleID;
    NSString *bundleIDString = [NSString stringWithCString:theBundleID.c_str() encoding:NSASCIIStringEncoding];;
...
{
    string theBundleID = bundleID;
    NSDictionary *allKeys = (NSDictionary *)getJSONFromFile(theBundleID, "Configuration");
